...
def cat_mode():
    ...
    arcade.draw texture_rectangle(texture.width//2, texture.height//2, texture.width, texture.height, texture, 0)
    pass
...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        # This command has to happen  efore we start drawing
        arcade.start_render()
